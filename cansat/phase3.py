...
# def phase3(goal_pos, port, baudrate, reset_pin, file_path_lora,file_path_al):
    ...
    while not (rt.isGoal() and rt.longitude_flag==True and rt.latitude_flag==True):
        ...
        while abs(deg) > 18.0 and times < 40: #5 #15だった　もうちょい大きくする 20 も良さそうだけど
...
if __name__ == "__main__":
    ...
    # goal_pos = [139.86149837367103, 35.77070816143917]#deg? 地球窯
    
    # goal_pos = [139.8614167, 35.7708586]# 地球窯横
    
    # goal_pos = [139.8613805, 35.7708929]# 地球窯横 コーン
    
    goal_pos = [139.8615156, 35.7710006]# コーン
    
    
    # goal_pos = [139.86258852095816, 35.77151711787813]#deg? スタバ
